...
describe("PlanetTable.vue", () => {
  test("shows table header if results are empty", () => {
    const wrapper = shallowMount(planetTable, {
      propsData: {
        planetsArray: [],
      },
    });
  ...
  test("shows as many rows as records", () => {
    const wrapper = shallowMount(planetTable, {
      propsData: {
        planetsArray: fullPlanetArray,
      },
    });
    const resultRows = wrapper.findAll("tbody tr");
    expect(resultRows).to.have.length(10);
  });
});
